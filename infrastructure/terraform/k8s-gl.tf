...
locals {
  folder_id             = "b1g6f5e97oomo9hnu6o0"            # Set your cloud folder ID.
  ...
  registry_name         = "registry-001"         # Set the name of Yandex Container Registry.
}
...
resource "yandex_container_registry" "registry-001" {
  name      = local.registry_name
  folder_id = local.folder_id

  labels = {
    registry = "registry-001"
  }
}